...
==============================
 Phase3 SMALL Interactive Menu (v2)
==============================
 1)  UP central only
 ...
 6)  SMOKE UP end-to-end (leaf→...→central) [old]
 61) SMOKE UP end-to-end (leaf→...→central) [v2 timeout fix]
...
while true; do
  ...
  case "${c}" in
   ...
   61)  bash "${DIR}/06a_smoke_up_end_to_end_v2.sh" ;;
